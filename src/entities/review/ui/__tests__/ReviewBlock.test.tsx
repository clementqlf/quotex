...
import {
  ...
  useUpdateReview,
  useDeleteReview,
} from '@/src/entities/review/lib/useReviewService';
...
jest.mock('@/src/entities/review/lib/useReviewService', () => ({
  useReviewsByBookId: jest.fn(),
...
describe('ReviewBlock Component', () => {
  ...
  beforeEach(() => {
    ...
    // Configurer les retours par défaut des hooks
    (useReviewsByBookId as jest.Mock).mockReturnValue({
      data: [],
      refetch: jest.fn(),
      isLoading: false,
    });
    ...
    (useDeleteReview as jest.Mock).mockReturnValue({
      mutate: jest.fn(),
      isPending: false,
    });
  });
