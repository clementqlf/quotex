...
export const formatBook = (book: any, userId: number = 0) => {
  if (!book) return null;
  let buyLinks = [];
  try {
...
export const formatAuthor = (author: any, userId: number = 0) => {
...
export const formatQuote = (quote: any, userId: number = 0) => {
